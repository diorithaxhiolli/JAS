...
namespace JAS.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            SignInManager<JASUser> signInManager,
        ...
        private JASUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<JASUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(JASUser)}'. " +
                    $"Ensure that '{nameof(JASUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
